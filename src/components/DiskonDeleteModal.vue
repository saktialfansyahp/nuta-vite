    ...
    <div class="bg-white rounded-3xl px-8 py-6 w-full max-w-md shadow-xl">
      ...
      <div class="flex justify-end gap-3">
        <button
          type="button"
          @click="$emit('cancel')"
          class="px-5 py-2.5 rounded-full text-sm font-medium text-red-500 border border-red-400 hover:bg-red-50 transition-colors"
        >
          Batalkan
        </button>
        ...
        <button
          type="button"
          @click="$emit('confirm')"
          class="px-5 py-2.5 rounded-full text-sm font-medium bg-red-500 text-white hover:bg-red-600 transition-colors"
        >
          Hapus
        </button>
      </div>
